...
const episodes = defineCollection({
	...
	schema: z.object({
		...
		track1_link: z.url().optional(),
		track2_link: z.url().optional(),
		track3_link: z.url().optional(),
		track4_link: z.url().optional(),
		track5_link: z.url().optional(),
		track6_link: z.url().optional(),
		track7_link: z.url().optional(),
